...
type Block struct {
	...
	FianlizedTime string       `protobuf:"bytes,6,opt,name=fianlized_time,json=fianlizedTime,proto3" json:"fianlized_time,omitempty"`
}
...
func (x *Block) GetFianlizedTime() string {
	if x != nil {
		return x.FianlizedTime
	}
	return ""
}
...
var file_sequencer_v1_block_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x66, 0x69, 0x61, 0x6e, 0x6c, 0x69, 0x7a, 0x65, 0x64,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x66, 0x69, 0x61,
	0x6e, 0x6c, 0x69, 0x7a, 0x65, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xee, 0x01, 0x0a, 0x0c, 0x42,
