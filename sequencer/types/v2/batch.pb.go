...
type BatchHeader struct {
	...
	L2Blocks      []*BlockHeader `protobuf:"bytes,4,rep,name=l2_blocks,json=l2Blocks,proto3" json:"l2_blocks,omitempty"`
	L1BlockNumber uint64         `protobuf:"varint,5,opt,name=l1_block_number,json=l1BlockNumber,proto3" json:"l1_block_number,omitempty"`
	L1TxHash      string         `protobuf:"bytes,6,opt,name=l1_tx_hash,json=l1TxHash,proto3" json:"l1_tx_hash,omitempty"`
}
...
func (x *BatchHeader) GetBatchHash() string {
	if x != nil {
		return x.BatchHash
	}
	return ""
...
type Batch struct {
	...
	AggSignature      string           `protobuf:"bytes,6,opt,name=agg_signature,json=aggSignature,proto3" json:"agg_signature,omitempty"`
	// meta data
	SequencedTime string `protobuf:"bytes,7,opt,name=sequenced_time,json=sequencedTime,proto3" json:"sequenced_time,omitempty"`
	FinalizedTime string `protobuf:"bytes,8,opt,name=finalized_time,json=finalizedTime,proto3" json:"finalized_time,omitempty"`
}
...
type BlsSignature struct {
	...
	ChainHeader     *BatchHeader     `protobuf:"bytes,1,opt,name=chain_header,json=chainHeader,proto3" json:"chain_header,omitempty"`
	CommitteeHeader *CommitteeHeader `protobuf:"bytes,2,opt,name=committee_header,json=committeeHeader,proto3" json:"committee_header,omitempty"`
...
func (x *BlsSignature) GetChainHeader() *BatchHeader {
	if x != nil {
...
var file_sequencer_v2_batch_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x61, 0x73, 0x68, 0x22, 0xe8, 0x01, 0x0a, 0x0b, 0x42, 0x61,
	...
	,
	...
	,
...
var file_sequencer_v2_batch_proto_goTypes = []interface{}{
...
var file_sequencer_v2_batch_proto_depIdxs = []int32{
	...
	1, // 3: sequencer.v2.BlsSignature.chain_header:type_name -> sequencer.v2.BatchHeader
...
func file_sequencer_v2_batch_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_sequencer_v2_batch_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sequencer_v2_batch_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sequencer_v2_batch_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sequencer_v2_batch_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Batch); i {
			case 0:
				return &v.state
			case 1:
		...
		file_sequencer_v2_batch_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
