...
type GetBlockRequest struct {
	...
	StakeAddress string `protobuf:"bytes,3,opt,name=stake_address,json=stakeAddress,proto3" json:"stake_address,omitempty"`
}
...
func (x *GetBlockRequest) GetChainId() uint32 {
	if x != nil {
		return x.ChainId
	}
	return 0
...
type GetBlockResponse struct {
	...
	CurrentBlockNumber uint64       `protobuf:"varint,2,opt,name=current_block_number,json=currentBlockNumber,proto3" json:"current_block_number,omitempty"`
}
...
func (x *GetBlockResponse) GetCurrentBlockNumber() uint64 {
	if x != nil {
...
type CommitBlockRequest struct {
	...
	BlsSignature     *types.BlsSignature `protobuf:"bytes,1,opt,name=bls_signature,json=blsSignature,proto3" json:"bls_signature,omitempty"`
	EpochBlockNumber uint64              `protobuf:"varint,2,opt,name=epoch_block_number,json=epochBlockNumber,proto3" json:"epoch_block_number,omitempty"`
...
func (x *CommitBlockRequest) GetBlsSignature() *types.BlsSignature {
	if x != nil {
...
func (x *CommitBlockRequest) GetEpochBlockNumber() uint64 {
	if x != nil {
...
var file_network_v1_network_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x74, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71,
	...
	0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x5f, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x74, 0x61, 0x6b, 0x65,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x6f, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x42, 0x6c,
	...
	0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x30, 0x0a, 0x14, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x74, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x12, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x42, 0x6c, 0x6f,
	0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0xba, 0x01, 0x0a, 0x12, 0x43, 0x6f, 0x6d,
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x6c, 0x73, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75,
	0x72, 0x65, 0x52, 0x0c, 0x62, 0x6c, 0x73, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65,
	0x12, 0x2c, 0x0a, 0x12, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f,
	0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x10, 0x65, 0x70,
	0x6f, 0x63, 0x68, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x17,
...
var file_network_v1_network_proto_goTypes = []interface{}{
	...
	(*types.BlsSignature)(nil),  // 7: sequencer.v1.BlsSignature
}
var file_network_v1_network_proto_depIdxs = []int32{
	6, // 0: network.v1.GetBlockResponse.block:type_name -> sequencer.v1.Block
	7, // 1: network.v1.CommitBlockRequest.bls_signature:type_name -> sequencer.v1.BlsSignature
